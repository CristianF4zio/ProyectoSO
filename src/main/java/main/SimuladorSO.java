...
public class SimuladorSO {
    ...
    public static void main(String[] args) {
        ...
        // Probar algoritmo SRTF
        System.out.println("=== PROBANDO ALGORITMO SRTF ===");
        probarAlgoritmo(srtf, gestorProcesos.getProcesosActivos());
        System.out.println();
    ...
    private static void probarAlgoritmo(AlgoritmoPlanificacion algoritmo, ListaSimple<Proceso> procesos) {
        System.out.println("Algoritmo: " + algoritmo.getNombre());
        
        ListaSimple<Proceso> procesosCopia = new ListaSimple<>();
        for (int i = 0; i < procesos.tamaño(); i++) {
            procesosCopia.agregar(procesos.obtener(i));
        }
        
        algoritmo.reordenarCola(procesosCopia);
        System.out.println("Orden de ejecución:");
        for (int i = 0; i < procesosCopia.tamaño(); i++) {
            Proceso p = procesosCopia.obtener(i);
    ...
    private static void mostrarEstadisticas(GestorProcesos gestorProcesos) {
        ...
        System.out.println("CPU_BOUND: " + gestorProcesos.getProcesosPorTipo(TipoProceso.CPU_BOUND).tamaño());
        System.out.println("IO_BOUND: " + gestorProcesos.getProcesosPorTipo(TipoProceso.IO_BOUND).tamaño());
    }
}
