...
public class Proceso {
    ...
    public int getCiclosTranscurridosIO() {
        return ciclosTranscurridosIO;
    }

    public void setCiclosTranscurridosIO(int ciclosTranscurridosIO) {
        this.ciclosTranscurridosIO = ciclosTranscurridosIO;
    }

    public boolean isEnOperacionIO() {
        return enOperacionIO;
    }

    public void setEnOperacionIO(boolean enOperacionIO) {
        this.enOperacionIO = enOperacionIO;
    }
